...
__all__ = ['get_dataset', 'get_csv_dataset', 'get_train_val_split', 'CovidXDataset', 'CassavaLeafDataset']
...
class CassavaLeafDataset(Dataset):
    ...
    def get_Weighted_RandomSampler(self,replacement = True, seed = 2147483647, use_generator = True):
        ...
        sample_weight = [class_weight[self.CLASSES[int(self.data_list[idx].split(',')[1])]] for idx in range(self.__len__())]
